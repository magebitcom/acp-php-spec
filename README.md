...
`Item` is `additionalProperties: false` and does not declare `quantity`, yet every upstream example
sends it. Accept it leniently until this is resolved upstream.
