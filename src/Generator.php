...
/**
 * Orchestrates generation of the single mutable interface tree from the ACP schema bundles
 */
class Generator
{
    ...
    private function processDefinition(
        ...
        $this->emit($this->typeMapper->definitionInterfaceName($defName), $definition, $namespace, $currentFile);
    }
