...
use Magebit\AcpSpec\Api\AgenticCheckout\CheckoutSessionWithOrderInterface;
 ...
 */
class CheckoutSessionWithOrder extends SpecObject implements CheckoutSessionWithOrderInterface
{
    /** @var string[] */
    ...
    {
        return $this->instanceOrNull(self::KEY_DISCOUNTS, \Magebit\AcpSpec\Api\AgenticCheckout\DiscountsResponseInterface::class);
    }
    ...
    {
        return $this->requireInstance(self::KEY_ORDER, \Magebit\AcpSpec\Api\AgenticCheckout\OrderInterface::class);
    }
