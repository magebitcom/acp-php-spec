 ...
 */
class FulfillmentDetails extends SpecObject implements FulfillmentDetailsInterface
{
    /**
     * @return string|null
     */
    ...
    {
        return $this->instanceOrNull(self::KEY_ADDRESS, \Magebit\AcpSpec\Api\AgenticCheckout\AddressInterface::class);
    }
