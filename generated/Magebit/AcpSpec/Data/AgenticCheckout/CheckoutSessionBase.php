...
use Magebit\AcpSpec\Api\AgenticCheckout\CheckoutSessionBaseInterface;
 ...
 */
class CheckoutSessionBase extends SpecObject implements CheckoutSessionBaseInterface
{
    /** @var string[] */
