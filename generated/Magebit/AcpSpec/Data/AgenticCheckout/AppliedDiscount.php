...
use Magebit\AcpSpec\Api\AgenticCheckout\DiscountAllocationInterface;
...
class AppliedDiscount extends SpecObject implements AppliedDiscountInterface
{
    ...
    {
        return $this->requireInstance(self::KEY_COUPON, \Magebit\AcpSpec\Api\AgenticCheckout\CouponInterface::class);
    }
    ...
    {
        return $this->instanceListOrNull(self::KEY_ALLOCATIONS, \Magebit\AcpSpec\Api\AgenticCheckout\DiscountAllocationInterface::class);
    }
