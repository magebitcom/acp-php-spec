...
use Magebit\AcpSpec\Api\DelegateAuthentication\DelegateAuthenticationSessionInterface;
use Magebit\AcpSpec\Runtime\SpecObject;

/**
 * Object representing the current state of the authentication session.
 */
class DelegateAuthenticationSession extends SpecObject implements DelegateAuthenticationSessionInterface
{
    /**
     * @return string
     */
